...
public class EmailUtils {
	...
	public EmailUtils(String userName, String password) throws MessagingException {
		this(userName,
				password,
				"imap.gmail.com",
				EmailFolder.INBOX);
	 ...
	 *
	 * @param username    Email username (e.g. anil@email.com)
	...
	public EmailUtils(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
		...
		try {
			props.load(new FileInputStream(System.getProperty("user.dir") + File.separator +"src/main/resources/email.properties"));
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(-1);
		}
